...
- **Discontinuités (> 50m) :** **0 km — Chaîne 100 % continue**
...
### Nuit 1 — Sant Llorenç de Morunys (km 283)

| Rôle | Nom de l'Hébergement | Téléphone Direct | WhatsApp | Écart à la Trace | Notes & Conditions |
|---|---|---|---|---|---|
| **Hôtel Principal A** | **Hotel Monegal** | `+34 973 49 20 80` | `+34 689 42 11 05` | Sur la trace (km 283) | Vélo en chambre ok, accueil tardif sur réservation |
...
| Rôle | Nom de l'Hébergement | Téléphone Direct | WhatsApp | Écart à la Trace | Notes & Conditions |
|---|---|---|---|---|---|
| **Hôtel Principal A (CP2)** | **Hostal Pirineos (CP2 Official)** | `+34 974 48 61 03` | `+34 650 33 22 11` | Directement sur le CP2 (km 600) | Hôtel partenaire du Control Point 2 |
| **Repli B** | **Hotel Pradas Ordesa (Broto)** | `+34 974 48 62 38` | `—` | À 4 km après CP2 (km 604) | Broto centre, garage vélo fermé |
| **Repli C** | **Hostal Villa de Torla (Torla)** | `+34 974 48 61 56` | `—` | À 7 km après CP2 (km 607) | Au pied du parc d'Ordesa |
...
| Compteur Guidon (Fichier GPX + km) | Cumul Course | Repère / Ravito / CP | Alt. | Statut & Notes |
|---|---:|---|---:|---|
| `1.TPRn6 Start parcours.gpx` — **km 72** | **km 72** | **Sant Feliu de Guíxols** | 0 m | Côte méditerranéenne, boulangeries, épiceries. |
| `2.TPRn6 start to parcours A road.gpx` — **km 1** | **km 105** | **Lloret de Mar** | 0 m | Dernière grande ville avant la section isolée des Guilleries (129 km). |
| `2.TPRn6 start to parcours A road.gpx` — **km 123** | **km 226** | **Puig-reig** | 0 m | Sortie Berguedà, supermarchés, restaurants. |
| `4.TPRn6 A to B Gravel.gpx` — **km 11** | **km 283** | **Sant Llorenç de Morunys (Nuit 1)** | 0 m | Étape 1 terminée. Hôtels, pharmacies, bars. |
| `5.TPRn6 parcours B.gpx` — **km 44** | **km 335** | **Coll de Nargó** | 0 m | Vallée du Segre, station-service, épicerie. |
| `6.TPRn6 B to C Hybrid.gpx` — **km 23** | **km 376** | **CP1 Pessonada (Control Point 1)** | 0 m | CP1 Officiel orga. Contrôle passif par photo/GPS. |
| `6.TPRn6 B to C Hybrid.gpx` — **km 33** | **km 385** | **Tremp / La Pobla de Segur** | 0 m | Gros ravito après CP1. Supermarchés Mercadona/BonÀrea. |
| `6.TPRn6 B to C Hybrid.gpx` — **km 72** | **km 425** | **El Pont de Suert** | 0 m | Dernière grande ville avant la haute vallée de Ribagorça. |
| `6.TPRn6 B to C Hybrid.gpx` — **km 115** | **km 468** | **Castejón de Sos** | 0 m | Vallée de Benasque, boulangeries, fontaine. |
| `8.TPRn6 C to D.gpx` — **km 20** | **km 600** | **Sarvisé / Hostal Pirineos (CP2 - Nuit 2)** | 0 m | CP2 Officiel orga. Cut-off Dimanche 27/09 à 16h00. |
| `8.TPRn6 C to D.gpx` — **km 56** | **km 636** | **Sabiñánigo / Jaca** | 0 m | Dernier gros point de ravito espagnol avant 100 km. |
| `8.TPRn6 C to D.gpx` — **km 178** | **km 759** | **Tardets / Mauléon** | 0 m | Entrée en France (Soule), commerces français. |
| `10.TPRn6 D to E.gpx` — **km 42** | **km 903** | **Pamplona (Navarre)** | 0 m | Ville H24, épiceries de nuit, pharmacies. |
| `10.TPRn6 D to E.gpx` — **km 113** | **km 975** | **Tolosa** | 0 m | Pays Basque espagnol, ravito avant CP3. |
| `10.TPRn6 D to E.gpx` — **km 149** | **km 1010** | **CP3 Gran Camping Zarautz (CP3 - Nuit 4)** | 0 m | CP3 Officiel orga. Cut-off Mardi 29/09 à 09h00. |
| `12.TPRn6 E to F.gpx` — **km 89** | **km 1118** | **Cambo-les-Bains** | 0 m | Dernière ville française avant la traversée d'Iraty (104 km). |
| `12.TPRn6 E to F.gpx` — **km 119** | **km 1147** | **Saint-Jean-Pied-de-Port (Nuit 3)** | 0 m | Étape 3 terminée. Hôtels, boulangeries, matériel. |
| `13.TPRn6 Parcours F.gpx` — **km 18** | **km 1191** | **Larrau** | 0 m | Village de montagne isolé. Horaires d'ouverture restreints. |
| `13.TPRn6 Parcours F.gpx` — **km 112** | **km 1284** | **Laruns (Vallée d'Ossau)** | 0 m | Fin du trou d'autonomie d'Iraty. Supermarché Carrefour Contact. |
| `13.TPRn6 Parcours F.gpx` — **km 158** | **km 1331** | **Argelès-Gazost / Luz-Saint-Sauveur** | 0 m | Vallée des gaves, ravito très dense au pied du Tourmalet. |
| `13.TPRn6 Parcours F.gpx` — **km 210** | **km 1383** | **Sainte-Marie-de-Campan** | 0 m | Pied est du Tourmalet et pied ouest d'Aspin. Épicerie/boulangerie. |
| `13.TPRn6 Parcours F.gpx` — **km 273** | **km 1445** | **Bagnères-de-Luchon (Nuit 5)** | 0 m | Étape 5 terminée. Hôtels, restaurants, pharmacies. |
| `13.TPRn6 Parcours F.gpx` — **km 368** | **km 1541** | **Seix (Ariège)** | 0 m | Cœur du Couserans. Alimentation générale. |
| `13.TPRn6 Parcours F.gpx` — **km 431** | **km 1604** | **Tarascon-sur-Ariège / Ax-les-Thermes** | 0 m | Vallée de l'Ariège, accès gare et supermarchés. |
| `13.TPRn6 Parcours F.gpx` — **km 541** | **km 1714** | **Mont-Louis / Puigcerdà** | 0 m | Cerdagne, avant l'ascension du Coll de Pal (2 194 m). |
| `14.TPRn6 F to End.gpx` — **km 51** | **km 1801** | **Ripoll / Olot (Nuit 6)** | 0 m | Dernière nuitée étape. Hôtels Bed & Bike. |
| `15.TPRn6 Finish.gpx` — **km 33** | **km 1896** | **Girona (Départ Officiel)** | 0 m | Départ vendredi 25 sept. à 07h00. Supermarchés & boutiques vélo. |
| `15.TPRn6 Finish.gpx` — **km 33** | **km 1896** | **Girona (Arrivée Finale 🏆)** | 0 m | Finish line officielle de la TransPyrenees Race No. 6 ! |
